...
const LandingPage = () => {
  ...
  const onButtonDISPLAYELEMENTSLabel1Click = useCallback(() => {
    // Please sync "Expert Page" to the project
  }, []);

  const onButtonDISPLAYELEMENTSLabel2Click = useCallback(() => {
    // Please sync "Blog Detail" to the project
  }, []);

  const onButtonDISPLAYELEMENTSLabel3Click = useCallback(() => {
    // Please sync "Expert Page" to the project
  }, []);
  ...
  const onButtonDISPLAYELEMENTSLabelAutocompleteClick = useCallback(() => {
    ...
    <>
      <nav className={styles.landingPage}>
        ...
        <div className={styles.feature}>
          ...
          <img className={styles.backgroundIcon} alt="" src="/background222.svg" />
          <div className={styles.feature1}>
            <div
              className={styles.metadata2}
            >{`{"config":{},"nodeName":"Feature","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:15.651Z"}`}</div>
            <p
            ...
            >
              <div
                className={styles.metadata}
              >{`{"config":{},"type":"Button","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:15.317Z","nodeName":"Button [DISPLAY_ELEMENTS=Label][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE1]"}`}</div>
              <div className={styles.label}>Read more</div>
              <div className={styles.iconDisplayElementslabel}>
                <div
                  className={styles.metadata}
                >{`{"config":{"STATE":"DEFAULT"},"type":"Icon","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:15.219Z","nodeName":"Icon [DISPLAY_ELEMENTS=Label][ICON=feather/heart][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE1]"}`}</div>
                <img className={styles.icon} alt="" src="/icon1222.svg" />
              </div>
            </button>
            ...
            <button
              className={styles.buttonDisplayElementslabel1}
              onClick={onButtonDISPLAYELEMENTSLabel1Click}
            >
              <div
                className={styles.metadata}
              >{`{"config":{},"type":"Button","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:15.602Z","nodeName":"Button [DISPLAY_ELEMENTS=Label][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE1]"}`}</div>
              <div className={styles.label1}>Go to expert</div>
              <div className={styles.iconDisplayElementslabel}>
                <div
                  className={styles.metadata}
                >{`{"config":{"STATE":"DEFAULT"},"type":"Icon","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:15.500Z","nodeName":"Icon [DISPLAY_ELEMENTS=Label][ICON=feather/heart][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE1]"}`}</div>
                <img className={styles.icon} alt="" src="/icon1222.svg" />
              </div>
            </button>
            <img className={styles.featureChild} alt="" src="/group-4222.svg" />
          ...
          <div className={styles.shapeParent}>
            <div className={styles.shape}>
              ...
              <img className={styles.sceneIcon} alt="" src="/scene222.svg" />
              <img className={styles.personIcon} alt="" src="/person222.svg" />
            </div>
            <div className={styles.groupParent}>
              ...
              >
                ...
                <p className={styles.textTagp}>
                  . The communication was smooth, and the project was completed
                  on time. I highly recommend this platform to anyone who needs
                  to find experts quickly and efficiently.”
                </p>
                <h4 className={styles.postTitleTagh51}>Adam Mada</h4>
                <h5 className={styles.categoryTaguiS}>4.5 stars</h5>
              </div>
              <div className={styles.shapeShapeshapes01BasicGroup}>
                <img
                ...
                <p className={styles.textTagp1}>
                  “The quality of the work was outstanding, and the rates were
                  very reasonable. I’m definitely going to use this platform
                  again in the future and recommend it to my colleagues.”
                </p>
                <b className={styles.postTitleTagh52}>Madam Madam</b>
                <b className={styles.categoryTaguiS1}>4 stars</b>
              </div>
              <button
                className={styles.buttonDisplayElementslabel2}
                onClick={onButtonDISPLAYELEMENTSLabel2Click}
              >
                <div
                  className={styles.metadata}
                ...
                <div className={styles.iconDisplayElementslabel2}>
                  ...
                  <img className={styles.icon2} alt="" src="/icon1222.svg" />
                </div>
              </button>
            </div>
            <div className={styles.feature2}>
              ...
              >{`{"config":{},"nodeName":"Feature","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T01:21:51.285Z"}`}</div>
              <div
            ...
            <div className={styles.shape1}>
              ...
              >{`{"config":{"SHAPE":"illustrations/Humaaans/01. Figures/Figure Sitting 4"},"type":"qm::Illustration","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T15:49:32.218Z"}`}</div>
              <img
          ...
          <div className={styles.shape2}>
            ...
            >{`{"config":{"SHAPE":"illustrations/Humaaans/03. Scenes/Scene - Plants"},"type":"qm::Illustration","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T15:59:52.963Z"}`}</div>
            <img
            ...
            />
            <img className={styles.leafTopIcon} alt="" src="/leaf-top222.svg" />
            <img
            ...
            />
            <img className={styles.macetaIcon} alt="" src="/maceta222.svg" />
            <img
          ...
          <button
            ...
            onClick={onButtonDISPLAYELEMENTSLabel3Click}
          >
            <div
            ...
            <div className={styles.iconDisplayElementslabel3}>
              ...
              <img className={styles.icon3} alt="" src="/icon110222.svg" />
            </div>
          </button>
        </div>
        <div className={styles.hero} data-animate-on-scroll>
          ...
          >{`{"config":{},"nodeName":"Hero","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T01:21:51.513Z"}`}</div>
          <div className={styles.shape3}>
            <div
              className={styles.metadata}
            >{`{"config":{"SHAPE":"illustrations/Humaaans/02. In Action/Reviewing Design"},"type":"qm::Illustration","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T04:24:30.653Z"}`}</div>
            <img className={styles.sceneIcon1} alt="" src="/scene1222.svg" />
            <img className={styles.figuresIcon} alt="" src="/figures222.svg" />
          </div>
          <b className={styles.scrollDownTagh6}>Scroll Down</b>
          <div
            className={styles.buttonDisplayElementslabel4}
            onClick={onButtonDISPLAYELEMENTSLabelAutocompleteClick}
          >
            <div
              className={styles.metadata}
            >{`{"config":{},"type":"Button","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T01:21:51.431Z","nodeName":"Button [DISPLAY_ELEMENTS=Label][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE1]"}`}</div>
            <div className={styles.label4}>Search An Expert Now</div>
            <div className={styles.iconDisplayElementslabel4}>
              ...
              <img className={styles.icon4} alt="" src="/icon2222.svg" />
            </div>
          </div>
          <h2
          ...
          <button className={styles.iconIconfeatherarrowDown}>
            <div
              className={styles.metadata}
            >{`{"config":{"SIZE":"LARGE","ICON":"feather/arrow-down-circle"},"type":"Icon","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T01:21:51.449Z","nodeName":"Icon [ICON=feather/arrow-down-circle][SIZE=LARGE][STYLE=STYLE1]"}`}</div>
            <img className={styles.icon5} alt="" src="/icon3222.svg" />
          </button>
          <div className={styles.pagination}>
            <div
              className={styles.metadata22}
            >{`{"config":{},"type":"Pagination","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T01:21:51.506Z","nodeName":"Pagination"}`}</div>
            <div className={styles.item}>
              <div
                className={styles.metadata}
              >{`{"config":{},"nodeName":"Item","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T01:21:51.457Z"}`}</div>
              <img className={styles.dotIcon} alt="" src="/dot222.svg" />
            </div>
            <div className={styles.item1}>
              <div
                className={styles.metadata}
              >{`{"config":{},"nodeName":"Item","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T01:21:51.464Z"}`}</div>
              <img className={styles.dotIcon} alt="" src="/dot1222.svg" />
            </div>
            <div className={styles.item2}>
              <div
                className={styles.metadata}
              >{`{"config":{},"nodeName":"Item","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T01:21:51.473Z"}`}</div>
              <img className={styles.dotIcon} alt="" src="/dot1222.svg" />
            </div>
            <div className={styles.item3}>
              <div
                className={styles.metadata}
              >{`{"config":{},"nodeName":"Item","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T01:21:51.480Z"}`}</div>
              <img className={styles.dotIcon} alt="" src="/dot1222.svg" />
            </div>
            <div className={styles.item4}>
              <div
                className={styles.metadata}
              >{`{"config":{},"nodeName":"Item","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T01:21:51.487Z"}`}</div>
              <img className={styles.dotIcon} alt="" src="/dot1222.svg" />
            </div>
            <div className={styles.item5}>
              <div
                className={styles.metadata}
              >{`{"config":{},"nodeName":"Item","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-16T01:21:51.494Z"}`}</div>
              <img className={styles.dotIcon} alt="" src="/dot1222.svg" />
            </div>
          </div>
        ...
        <nav className={styles.header}>
          ...
          >{`{"config":{},"nodeName":"Header","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.201Z"}`}</div>
          <a className={styles.titleTagh6}>TinnCann</a>
          <div className={styles.tabsWrapper}>
            <nav className={styles.tabs}>
              <div
                className={styles.metadata}
              >{`{"config":{},"type":"Tabs","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.903Z","nodeName":"Tabs"}`}</div>
              <div className={styles.placeholderTabItem}>
                <div
                  className={styles.metadata}
                >{`{"config":{},"nodeName":"[PLACEHOLDER] Tab Item","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.261Z"}`}</div>
                <div className={styles.area}>
                  <div
                    className={styles.metadata}
                  >{`{"config":{},"nodeName":"Area","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.213Z"}`}</div>
              ...
              >
                <div
                  className={styles.metadata}
                >{`{"config":{},"type":"TabItem","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.399Z","nodeName":"Tab Item [STATE=DEFAULT]"}`}</div>
                <div className={styles.area1}>
                  <div
                    className={styles.metadata}
                  >{`{"config":{},"nodeName":"Area","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.307Z"}`}</div>
                  <div className={styles.bar} />
                </div>
                <div className={styles.label6}>Forum</div>
              </Link>
              <a
              ...
              >
                ...
                >{`{"config":{},"type":"TabItem","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.539Z","nodeName":"Tab Item [STATE=DEFAULT]"}`}</div>
                <div className={styles.area2}>
                  <div
                    className={styles.metadata}
                  >{`{"config":{},"nodeName":"Area","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.448Z"}`}</div>
                  <div className={styles.bar} />
                </div>
              ...
              >
                <div
                  className={styles.metadata}
                >{`{"config":{},"type":"TabItem","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.677Z","nodeName":"Tab Item [STATE=DEFAULT]"}`}</div>
                <div className={styles.area3}>
                  <div
                    className={styles.metadata}
                  >{`{"config":{},"nodeName":"Area","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.586Z"}`}</div>
                  <div className={styles.bar} />
                </div>
                <div className={styles.label8}>Search Experts</div>
              </a>
              <a className={styles.tabItemStateactive}>
                <div
                  className={styles.metadata}
                >{`{"config":{"STATE":"ACTIVE"},"type":"TabItem","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.812Z","nodeName":"Tab Item [STATE=ACTIVE]"}`}</div>
                <div className={styles.area4}>
                  <div
                    className={styles.metadata}
                  >{`{"config":{},"nodeName":"Area","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.722Z"}`}</div>
                  <div className={styles.barStateactive} />
                </div>
                <div className={styles.label9}>Home</div>
              </a>
            </nav>
          </div>
          <button
            className={styles.buttonDisplayElementslabel5}
            onClick={openContactPopup}
          >
            <div
              className={styles.metadata}
            >{`{"config":{},"type":"Button","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.089Z","nodeName":"Button [DISPLAY_ELEMENTS=Label][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE1]"}`}</div>
            <div className={styles.label10}>Contact</div>
            <div className={styles.iconDisplayElementslabel}>
              <div
                className={styles.metadata}
              >{`{"config":{"STATE":"DEFAULT"},"type":"Icon","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:17.994Z","nodeName":"Icon [DISPLAY_ELEMENTS=Label][ICON=feather/heart][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE1]"}`}</div>
              <img className={styles.icon} alt="" src="/icon4222.svg" />
            </div>
          </button>
          <div className={styles.iconIconfeathersearchsiz}>
            <div
              className={styles.metadata43}
            >{`{"config":{"SIZE":"LARGE","ICON":"feather/search"},"type":"Icon","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.155Z","nodeName":"Icon [ICON=feather/search][SIZE=LARGE][STYLE=STYLE1]"}`}</div>
            <img className={styles.icon7} alt="" src="/icon5222.svg" />
          </div>
        </nav>
        <b className={styles.titleTagh11}>
          <p className={styles.tinncann}>
            “Whether you need assistance with a technical problem, legal matter,
            creative project, or any other area of expertise, we can help you
        ...
        <div className={styles.footer}>
          ...
          >{`{"config":{},"nodeName":"Footer","type":"Group","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.905Z"}`}</div>
          ...
          <div className={styles.circleButtonSizemediumst}>
            <div
              className={styles.metadata}
            >{`{"config":{"STYLE":"STYLE2"},"type":"CircleButton","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.377Z","nodeName":"Circle Button [SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE2]"}`}</div>
            <div className={styles.iconIconfeatherinstagram}>
              <div
                className={styles.metadata}
              >{`{"config":{"STYLE":"STYLE2","STATE":"DEFAULT","ICON":"feather/instagram"},"type":"Icon","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.324Z","nodeName":"Icon [ICON=feather/instagram][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE2]"}`}</div>
              <div className={styles.icon8}>
                <img
                  className={styles.bc1799d35ce9411296c7766fd5Icon}
                  alt=""
                  src="/bc1799d35ce9411296c7766fd57b49ab222.svg"
                />
                <div className={styles.bb24a43Ab29467cB41bFfd5876} />
              </div>
            </div>
          </div>
          <button className={styles.circleButtonSizemediumst1}>
            <div
              className={styles.metadata}
            >{`{"config":{"STYLE":"STYLE2"},"type":"CircleButton","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.493Z","nodeName":"Circle Button [SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE2]"}`}</div>
            <div className={styles.iconIconfeathertwittersi}>
              <div
                className={styles.metadata}
              >{`{"config":{"STYLE":"STYLE2","STATE":"DEFAULT","ICON":"feather/twitter"},"type":"Icon","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.443Z","nodeName":"Icon [ICON=feather/twitter][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE2]"}`}</div>
              <img className={styles.icon9} alt="" src="/icon6222.svg" />
            </div>
          </button>
          <button className={styles.circleButtonSizemediumst2}>
            <div
              className={styles.metadata}
            >{`{"config":{"STYLE":"STYLE2"},"type":"CircleButton","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.605Z","nodeName":"Circle Button [SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE2]"}`}</div>
            <div className={styles.iconIconfeatherfacebooks}>
              <div
                className={styles.metadata}
              >{`{"config":{"STYLE":"STYLE2","STATE":"DEFAULT","ICON":"feather/facebook"},"type":"Icon","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.553Z","nodeName":"Icon [ICON=feather/facebook][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE2]"}`}</div>
              <div className={styles.areaIconfeatherfacebooks} />
              <div className={styles.icon10}>
                <button className={styles.a793690c43fc928dFfe269f170} />
              </div>
            </div>
          </button>
          <div className={styles.circleButtonSizemediumst3}>
            <div
              className={styles.metadata}
            >{`{"config":{"STYLE":"STYLE2"},"type":"CircleButton","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.737Z","nodeName":"Circle Button [SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE2]"}`}</div>
            <div className={styles.iconIconfeatherlinkedins}>
              <div
                className={styles.metadata}
              >{`{"config":{"STYLE":"STYLE2","STATE":"DEFAULT","ICON":"feather/linkedin"},"type":"Icon","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.674Z","nodeName":"Icon [ICON=feather/linkedin][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE2]"}`}</div>
              <img className={styles.icon11} alt="" src="/icon7222.svg" />
            </div>
          </div>
          <div className={styles.circleButtonSizemediumst4}>
            <div
              className={styles.metadata}
            >{`{"config":{"STYLE":"STYLE2"},"type":"CircleButton","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.854Z","nodeName":"Circle Button [SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE2]"}`}</div>
            <div className={styles.iconIconfeathermailsize}>
              <div
                className={styles.metadata}
              >{`{"config":{"STYLE":"STYLE2","STATE":"DEFAULT","ICON":"feather/mail"},"type":"Icon","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-17T23:07:18.807Z","nodeName":"Icon [ICON=feather/mail][SIZE=MEDIUM][STATE=DEFAULT][STYLE=STYLE2]"}`}</div>
              <div className={styles.areaIconfeathermailsize} />
              <img className={styles.icon12} alt="" src="/icon8222.svg" />
            </div>
          </div>
          <h4 className={styles.mockupShopClassic}>TinnCann</h4>
        </div>
        <button className={styles.button} onClick={openSignInPopup1}>
          <div
            className={styles.metadata55}
          >{`{"config":{},"type":"Button","nodeName":"Button","children":["b65edfac-4573-453c-ba83-21e28e74a502","4a72394f-ea1a-4af2-be12-71baf0c819a8","5bde2f17-5c27-4cef-aba8-45273e2844a3","d990dd1a-2e2b-4d6e-acb4-664a69318184","4fd26d2c-3bbb-4189-9974-7a293e3eb0ec","c1d82b4d-fc56-4a2a-b7e7-62ba08a6aea7","3e564f76-2fac-4c05-904d-a0f70ec0f87b","c0f99d42-9961-41bc-9e4c-aebe2cf74ffa"],"__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-18T01:29:13.791Z"}`}</div>
          <div className={styles.component312} onClick={openSignInPopup}>
            <div className={styles.area5} />
            <div className={styles.label11}>Sign in</div>
          </div>
          <div className={styles.icon13}>
            <div
              className={styles.metadata56}
            >{`{"config":{},"type":"Icon","nodeName":"Icon","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-18T01:29:13.742Z"}`}</div>
            <div className={styles.icon14}>
              <div
                className={styles.metadata57}
              >{`{"config":{},"nodeName":"Icon","type":"Group","theme":"Foundation","__plugin":"Mockup","__version":"1.5.0","__lastUpdate":"2023-03-18T01:29:13.684Z"}`}</div>
              <img className={styles.pathIcon} alt="" src="/path222.svg" />
            </div>
          </div>
        </button>
      </nav>
      ...
      {isSignInPopup1Open && (
        ...
        >
          <SignIn onClose={closeSignInPopup1} />
        </PortalPopup>
      )}
      {isSignInPopupOpen && (
        <PortalPopup

    ...
    return (
        ...
        <HeaderComponent/>
            <div className="profile-page">
                ...
                <a className="email-markzuckmetacom">
                    Email: markzuck@meta.com
                </a>
                ...
                <img
                    className="bill-gates-icon1"
                    alt=""
                    src="/bill-gates1@2x.png"
                />
                <a className="previous-meetings">Previous Meetings</a>
                <img
                    className="elon-musk-icon"
                    alt=""
                    src="/elon-musk@2x.png"
                />
                ...
                <a className="bill-gates-senior-software-container">
                    ...
                    <p className="senior-software-enginneer">
